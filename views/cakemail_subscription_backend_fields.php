            <?php foreach ( $instance['selected_list']->fields as $field => $values ) { ?>
                ...
                <?php if ( $field != 'id' && $field != 'registered' ) { ?>
                    <li class="<?php echo !$show && $field != 'email' ? 'drag-disabled' : ''; ?>">
                        ...
                        <input class="" id="<?php echo $this->get_field_id( 'field-'.$field ); ?>" name="<?php echo $this->get_field_name( 'field-'.$field ); ?>" type="text" placeholder="Label for: <?php echo $field; ?>" value="<?php echo $label ?>" />
                    </li>
                <?php } ?>
            <?php } ?>
